  ...
  $(".main-tabs__content").each(function () {
    ...
    function loadTab1(tabObj1) {
      ...
      th.find(containerId1).load(tabObj1.attr('href'), function () {
        ...
        $(".tab__slider-big").find("img").each(function () {

          $(this).parent().addClass("gal-link").attr("href", $(this).attr("data-lazy"))
          // .wrap('<a href="dop/'+$(this).attr("data-lazy")+'">')
        })

        $(".tab__slider2 , .tab__slide-slider, .tab__slider-big").each(function () {
