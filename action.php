...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['time'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;"> Время для связи:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['time'] . '</b></td></tr>';
    }
...
$data = array(
    ...
    'values' => array(
        ...
        'custom' => array(
            ...
            array('input_id' => 129789, 'value' => $_POST['material']),
            array('input_id' => 129786, 'value' => $_POST['material_stol']),
